const Footer = () => {
  return (
    <div className="flex gap-5 w-full h-screen bg-zinc-900 p-20">
      <div className=" w-1/2 h-full flex flex-col justify-between font-['Stencil'] uppercase">
        <div className="heading ">
          <h1 className=" text-[8vw] leading-[10vw] -mb-10 font-semibold ">
            Eye-
          </h1>
          <h1 className=" text-[8vw] leading-[10vw] -mb-10 font-semibold  ">
            Opening
      ...
      <div className=" w-1/2 ">
        <h1 className=" text-[5vw] font-['Stencil'] -mb-10 font-semibold ">
          Presentations
        </h1>
        <div className=" links text-white mt-10 flex flex-col font-['Neue Montreal']  font-semibold text-xl">
          {["Instagram", "Facbook", "Twitter", "Whatsapp"].map(
            (item, index) => (
